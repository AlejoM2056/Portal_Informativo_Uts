...
<form id="noticiaForm" method="POST" action="{{ route('admin.noticias.update', $noticia) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
        ...
        <div class="col-lg-4">
            <div class="form-card mb-4">
                ...
                <div class="form-group-admin">
                    ...
                    <input type="date" class="form-control-admin @error('fecha') is-invalid @enderror" id="fecha" name="fecha" value="{{ old('fecha', $noticia->fecha->format('Y-m-d')) }}">
                    @error('fecha')
                        <div class="text-danger small mt-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="d-grid gap-2 mt-4">
                    <button type="submit" class="btn-primary-admin">
                        <i class="bi bi-check-circle"></i> Actualizar Noticia
                    </button>
...
<script>
    function confirmarEliminarImagen() {
        document.getElementById('imagenActual').closest('.mb-3').style.display = 'none';
    ...
    quillTitulo.root.innerHTML = {!! json_encode(old('titulo', $noticia->titulo)) !!};
    ...
    quillDescripcion.root.innerHTML = {!! json_encode(old('descripcion', $noticia->descripcion)) !!};
    ...
    quill.root.innerHTML = {!! json_encode(old('contenido', $noticia->contenido)) !!};
